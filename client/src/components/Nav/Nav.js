...
class Nav extends Component {
  ...
  fetchShow = () => {
    axios({
      method: "GET",
      url:
        "https://api.themoviedb.org/3/search/tv?api_key=93b28d68c5a5b44af2e7b2b65e2e4ee6&language=en-US&query=" +
    ...
    return (
      <div className="Nav">
        ...
        <div className="search">
          ...
          />
          <div className="search-button" onClick={this.fetchShow}>
            <i className="fas fa-search fa-1x" id="search_button" />
          </div>
        </div>
        <Link to="/profile">
